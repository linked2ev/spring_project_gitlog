...
public class ImgPaginationRenderer {
	...
	public ImgPaginationRenderer() {
        firstPageLabel    = "<a href=\"javascript:;\" onclick=\"{0}({1}); return false;\" class=\"page-first\"><em class=\"page-btn first dis\"></em><span class=\"screen_out\">처음 페이지</span></a> ";
        previousPageLabel = "<a href=\"javascript:;\" onclick=\"{0}({1}); return false;\" class=\"page-prev\"><em class=\"page-btn prev dis\"></em><span class=\"screen_out\">이전 페이지</span></a> ";
        ...
        nextPageLabel     = "<a href=\"javascript:;\" onclick=\"{0}({1}); return false;\" class=\"page-next\"><em class=\"page-btn next\"></em><span class=\"screen_out\">다음 페이지</span></a> ";
        lastPageLabel     = "<a href=\"javascript:;\" onclick=\"{0}({1}); return false;\" class=\"page-end\"><em class=\"page-btn end\"></em><span class=\"screen_out\">마지막 페이지</span></a> ";
	}
